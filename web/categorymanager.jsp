                        ...
                        <div class="card">
                            <div class="row" style="">
                                ...
                                <div class="col-lg-6" style="text-align: center; margin-top: 20px; margin-bottom: 20px;padding-top: 20px"F>
                                    <form action="managercategory" method="post" style="display: flex; justify-content: center">
                                        <input name="valueSearch" value="${requestScope.searchValue != null ? requestScope.searchValue : ""}" id="searchId" type="text" oninput="searchByName()" placeholder="Search category name" style="width: 60%; padding: 4px 10px; border-radius: 15px">
                                        ...
                                        <c:forEach items="${listAllCategory}" var="o">
                                            <tr>
                                                ...
                                                <td class="text_page" style="padding: 0 12px 16px">
                                                    <a href="updatecategory?cid=${o.id}"><button type="button" class="btn btn-warning"><i class="fa-solid fa-pen"></i></button></a>
                                                    <a href="deletecategory?cid=${o.id}">
