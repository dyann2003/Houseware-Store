...
<html>
    ...
    <body>
        <div id="header_right" >
            <div class="header_top_right"  style="background-color: black; padding-right: 20px">
                                    ...
                                    <div >
                                        <c:if test="${sessionScope.cart != null && sessionScope.cartSize != 0}">
                                            <c:forEach items="${sessionScope.listItemsInCart}" var="p">
                                                <div class="cart_item">
                                                    <div class="cart_img">
                                                        <a href="detail?pid=${p.product.id}">
                                                    ...
                                                    <div class="cart_info">
                                                        <a href="detail?pid=${p.product.id}">${p.product.name}</a>
                                                        <p style="color: black"><span style="color: black">
                                                                <input type="hidden" class="amount" value="${p.product.price}">
                                    ...
                                    <div class="cart_table_border">
                                        <div class="cart_total mt-10">
                                            ...
                                            <span class="price" style="color: black">
                                                ...
                                                <span class="num currency total"></span>
                                            </span>
                                        </div>
                    ...
                    <ul>
                        ...
                        <c:if test="${sessionScope.account!=null}">
                            <li onclick="change()" style="position: relative; cursor: pointer;">
                                <img src="${sessionScope.account.getImage()}" width="40px" style="color: white; border-radius: 50% ;border: 2px solid white;">
                                <ul id="avt" class="header_avt" style="margin-top:25px;
                                    ...
                                    <li class="option_avt"><a href="cart">Checkout</a>
                                    <li class="option_avt"><a href="${sessionScope.account.roleID==1?"login":"profile"}">My Account</a></li>
                                    <li class="option_avt">
        ...
        <script type="text/javascript">
                                            ...
                                            document.addEventListener("DOMContentLoaded", function () {
                                                // Select all price elements within the cart items
                                                let cartItemPriceElements = document.querySelectorAll('.cart_item');

                                                // Loop through each price element within the cart items
                                                cartItemPriceElements.forEach(function (priceElement) {
                                                ...
                                                // Select the total price element (if it exists)
                                                let totalPriceElement = document.querySelector('.cart_table_border');

                                                if (totalPriceElement) {
                                                    // Get the total amount from the hidden input inside the total price element
                                                    let totalAmount = parseInt(totalPriceElement.querySelector(".amount").value);

                                                    // Create a new formatter for the total price element
                                                    let totalFormatter = new Intl.NumberFormat("vi-VN", {style: "currency", currency: "VND"});

                                                    // Format the total amount and set it as the inner text of the total price element
                                                    totalPriceElement.querySelector(".num").innerText = totalFormatter.format(totalAmount);
                                                } else {
