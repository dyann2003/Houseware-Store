<%-- 
    Document   : order
    Created on : Mar 13, 2024, 2:10:08 PM
    Author     : nduya
--%>
    ...
    <body onload="time()" class="app sidebar-mini rtl">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item" href="managerAccount"><i class='app-menu__icon bx bx-user-voice'></i><span
                            ...
                            <tbody>
                                <c:forEach items="${bill}" var="b">
                                    <tr>
                                        ...
                                        <td>${b.date}</td>
                                        <td>${b.total}</td>                                
                                        <td><a style=" color: rgb(245 157 57);background-color: rgb(251 226 197); padding: 5px;border-radius: 5px;" href="ordermanager?action=showdetail&bill_id=${b.orderId}"><i class="fa"></i>Chi tiết đơn hàng</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
