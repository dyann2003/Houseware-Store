                                ...
                                <div style="padding: 10px 15px">
                                    <div class="d-flex justify-content-between p-md-1">
                                        ...
                                        <div style="text-align: end">
                                            ...
                                            <p class="mb-0"></p>
                                            <h2 class="h1 mb-0" id="priceContainer">
                                                <input type="hidden" id="amount" value="${requestScope.totalmoneyAll}">
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                if (priceContainer) {
                    ...
                    let amount = parseFloat(document.getElementById("amount").value); // Convert to double
                    priceContainer.innerText = formatter.format(amount);
                } else {
                    console.error("Element with ID 'priceContainer' not found.");
                }
            });
